...
tests/test_week12_exercise02.py imports directly from here. Need a helper
function or class of your own? Add another .py file next to this one inside
exercises/week12/exercise02/ and import it as a submodule (e.g.
`from exercises.week12.exercise02 import helpers`) -- solution.py just has to
