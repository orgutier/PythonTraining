...
tests/test_week11_exercise05.py imports directly from here. Need a helper
function or class of your own? Add another .py file next to this one inside
exercises/week11/exercise05/ and import it as a submodule (e.g.
`from exercises.week11.exercise05 import helpers`) -- solution.py just has to
