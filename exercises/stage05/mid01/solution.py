...
tests/test_stage05_mid01.py imports directly from here. Need a helper
function or class of your own? Add another .py file next to this one inside
exercises/stage05/mid01/ and import it as a submodule (e.g.
`from exercises.stage05.mid01 import helpers`) -- solution.py just has to
