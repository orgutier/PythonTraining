...
tests/test_week05_exercise01.py imports directly from here. Need a helper
function or class of your own? Add another .py file next to this one inside
exercises/week05/exercise01/ and import it as a submodule (e.g.
`from exercises.week05.exercise01 import helpers`) -- solution.py just has to
