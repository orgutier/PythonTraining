...
tests/test_stage10_exercise04.py imports directly from here. Need a helper
function or class of your own? Add another .py file next to this one inside
exercises/stage10/exercise04/ and import it as a submodule (e.g.
`from exercises.stage10.exercise04 import helpers`) -- solution.py just has to
