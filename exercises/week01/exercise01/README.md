...
All four parameters above use annotated types (`name: str`, `age: int`, ...) -- keep doing that in every function you write this week; it's not optional decoration, `isinstance()` checks later in the week assume callers respect it.
