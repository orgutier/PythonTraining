...
tests/test_stage07_exercise01.py imports directly from here. Need a helper
function or class of your own? Add another .py file next to this one inside
exercises/stage07/exercise01/ and import it as a submodule (e.g.
`from exercises.stage07.exercise01 import helpers`) -- solution.py just has to
