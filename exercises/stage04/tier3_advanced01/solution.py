...
tests/test_stage04_tier3_advanced01.py imports directly from here. Need a helper
function or class of your own? Add another .py file next to this one inside
exercises/stage04/tier3_advanced01/ and import it as a submodule (e.g.
`from exercises.stage04.tier3_advanced01 import helpers`) -- solution.py just has to
