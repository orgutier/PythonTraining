"""
Python Fundamentals -- Hello, World! (Environment Check)
...
tests/test_stage01_hello_world.py imports directly from here. Need a helper
function or class of your own? Add another .py file next to this one inside
exercises/stage01/hello_world/ and import it as a submodule (e.g.
`from exercises.stage01.hello_world import helpers`) -- solution.py just has to
