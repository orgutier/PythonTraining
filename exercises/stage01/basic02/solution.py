...
tests/test_stage01_basic02.py imports directly from here. Need a helper
function or class of your own? Add another .py file next to this one inside
exercises/stage01/basic02/ and import it as a submodule (e.g.
`from exercises.stage01.basic02 import helpers`) -- solution.py just has to
