...
tests/test_week03_exercise07.py imports directly from here. Need a helper
function or class of your own? Add another .py file next to this one inside
exercises/week03/exercise07/ and import it as a submodule (e.g.
`from exercises.week03.exercise07 import helpers`) -- solution.py just has to
