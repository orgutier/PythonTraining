...
tests/test_week02_exercise04.py imports directly from here. Need a helper
function or class of your own? Add another .py file next to this one inside
exercises/week02/exercise04/ and import it as a submodule (e.g.
`from exercises.week02.exercise04 import helpers`) -- solution.py just has to
