...
tests/test_stage03_exercise03.py imports directly from here. Need a helper
function or class of your own? Add another .py file next to this one inside
exercises/stage03/exercise03/ and import it as a submodule (e.g.
`from exercises.stage03.exercise03 import helpers`) -- solution.py just has to
