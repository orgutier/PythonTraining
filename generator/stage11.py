...
''',
        "test": '''\
import numpy as np
from exercises.stage11.exercise01.solution import (
    load_image,
    save_image,
    get_dimensions,
    get_channel_count,
...
''',
        "test": '''\
import numpy as np
from exercises.stage11.exercise02.solution import (
    to_grayscale,
    to_rgb,
    resize_image,
    resize_by_scale,
...
''',
        "test": '''\
import numpy as np
from exercises.stage11.exercise03.solution import (
    draw_rectangle,
...
import cv2
import numpy as np
from exercises.stage11.exercise05.solution import (
    detect_edges,
