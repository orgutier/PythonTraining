...
Week 14 has no new keywords/dunders/concepts of its own in
...
every other week. The 3x-per-concept coverage bar this generator applies
everywhere else doesn't map onto a week whose entire point is picking your
own second module and synthesizing it with the rest of the course -- that
choice belongs to the trainee, not a fixed exercise spec. So this week
stays a single, cohesive graded exercise (still moved into the same
exercises/week14/exerciseXX/ + solution.py convention as every other week,
...
OVERVIEW = (
    ...
    "(__len__, __contains__), and the json module from earlier weeks. "
    "pandas/requests/opencv/FastAPI usage is bonus scope for your own "
    "capstone idea on top of this, not required here -- see the week's "
...
EXERCISES = [
    {
        ...
        "readme": (
            ...
            "combines two or more earlier topics (see this week's schedule) "
...
''',
        "test": '''\
from exercises.week14.exercise01.solution import Book, Library
