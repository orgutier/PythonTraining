...
''',
        "test": '''\
from exercises.stage03.exercise02.solution import sum_all, build_config, describe_call
...
''',
        "test": '''\
from exercises.stage03.exercise05.solution import log_calls, count_calls, uppercase_result
...
''',
        "test": '''\
from exercises.stage03.exercise08.solution import (
    count_up_to,
    evens_only,
    infinite_counter,
    take,
