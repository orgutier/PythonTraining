"""
Aggregated tests for week14 -- Capstone.
Auto-generated by generate.py from generator/week14.py -- edit that file, not this one, then re-run `python generate.py`.
"""


# ------------------------------------------------------------------ exercise01: Library and Book
